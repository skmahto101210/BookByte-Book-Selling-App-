  ...
  return (
    <section className="py-10 lg:py-20 bg-stone-100 font-poppins dark:bg-gray-800 ">
      <div className="max-w-6xl py-4 mx-auto lg:py-6 md:px-6  ">
        <div className="flex flex-wrap pt-9 h-screen">
              ...
              <div className="flex flex-wrap items-center">
                <div className="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                  <div className="p-6 bg-white dark:bg-gray-900">
                    <span className="text-pink-500 dark:text-blue-400">
                      <svg
          ...
          <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <img
              ...
              alt=""
              className="relative z-40 object-cover w-full h-3/4 rounded shadow-xl shadow-gray-700"
            />
          </div>
        </div>
      </div>
